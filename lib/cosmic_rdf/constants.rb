...
#  RDF-file name is FILES[] base name...
  ...
  PREDICATE_PREFIX = {
    sample:     '@prefix s:<http://med2rdf.org/cosmic#> .',
    mutation:   '@prefix mt:<http://med2rdf.org/cosmic#> .',
    census:     '@prefix cn:<http://med2rdf.org/cosmic#> .',
    screen:     '@prefix sc:<http://med2rdf.org/cosmic#> .',
    target:     '@prefix t:<http://med2rdf.org/cosmic#> .',
    cna:        '@prefix c:<http://med2rdf.org/cosmic#> .',
    ncv:        '@prefix n:<http://med2rdf.org/cosmic#> .',
    fusion:     '@prefix f:<http://med2rdf.org/cosmic#> .',
    expression: '@prefix e:<http://med2rdf.org/cosmic#> .',
    resistance: '@prefix r:<http://med2rdf.org/cosmic#> .',
    methylation:'@prefix me:<http://med2rdf.org/cosmic#> .',
    breakpoint: '@prefix b:<http://med2rdf.org/cosmic#> .',
    hgnc:       '@prefix h:<http://med2rdf.org/cosmic#> .',
    struct:     '@prefix st:<http://med2rdf.org/cosmic#> .',
    transcript: '@prefix t:<http://med2rdf.org/cosmic#> .',
